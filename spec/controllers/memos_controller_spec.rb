  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved memo as @memo" do
        ...
        post :create, {:memo => { "body" => "invalid value" }}, valid_session
        assigns(:memo).should be_a_new(Memo)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested memo" do
        ...
        Memo.any_instance.should_receive(:update).with({ "body" => "MyString" })
        put :update, {:id => memo.to_param, :memo => { "body" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the memo as @memo" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Memo.any_instance.stub(:save).and_return(false)
        put :update, {:id => memo.to_param, :memo => { "body" => "invalid value" }}, valid_session
        assigns(:memo).should eq(memo)
      end
